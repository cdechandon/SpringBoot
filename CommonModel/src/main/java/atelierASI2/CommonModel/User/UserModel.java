...
public class UserModel implements Serializable {
	...
	public void setPwd(String pwd) {
	  ...
	  public Set<CardModel> getCardList() { return cardList; }
	  
	  public void setCardList(Set<CardModel> cardList) { this.cardList = cardList;
	  }
	  ...
	  public void addCard(CardModel card) { this.cardList.add(card);
	  card.setUser(this); }
	  
	  private boolean checkIfCard(CardModel c){ for(CardModel c_c: this.cardList){
	  if(c_c.getId()==c.getId()){ return true; } } return false; }
